import XCTest
@testable import Coreplank

@MainActor
final class CoreplankTests: XCTestCase {
    ...
    func testFreeTierLimitBlocksAdd() {
        ...
        let result = store.add(PlankEntry())
    ...
    func testPersistenceRoundTrip() {
        let store = makeStore()
        _ = store.add(PlankEntry(notes: "persisted"))
        let reloaded = Store()
